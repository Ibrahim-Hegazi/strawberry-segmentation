...
from fastapi.responses import FileResponse, JSONResponse # Changed from StreamingResponse
from ultralytics import YOLO # Added for YOLO model
import cv2 # Added for image processing with OpenCV
import numpy as np # Added for numerical operations with images
import io
import os
import uuid # Added for unique request IDs
from pathlib import Path # Added for path manipulation
import zipfile # Added for creating zip archives
...
async def load_model_and_create_dirs():
    ...
    try:
        ...
        model = YOLO("models/best.pt")  # Railway version
        # model = YOLO(
        #     r"C:\Users\Ibrahim_Hegazi\Desktop\AI\ModelOutput After Training on Kaggle Notebooks\kaggle\working\strawberry_seg\weights\best.pt"
        # ) # Local Version
